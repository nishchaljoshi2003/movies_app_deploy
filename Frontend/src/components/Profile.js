...
const Profile = () => {
    ...
    async function fetchFavorites() {
        ...
        try {
            ...
            console.log('Favorites fetched:', data); // Debugging line
            setFavorites(data);
            setLoading(false);
        } catch (error) {
    ...
    async function fetchData() {
        try {
            ...
            console.log('Movies fetched from TMDB:', dataJ.results); // Debugging line
    ...
    const favoriteMovies = allMovies.filter(movie => {
        ...
        return favorites.some(fav => fav.movie_id === movie.movie_id);
    });
